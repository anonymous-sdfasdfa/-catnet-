...
from utils.io_IPCGANS import check_dir,Img_to_zero_center
...
parser.add_argument('--val_interval', type=int, help='Number of steps to validate', default=20)
parser.add_argument('--save_interval', type=int, help='Number of batches to save model', default=20)
...
def main():
    ...
    for epoch in range(args.max_epoches):
        logger.info('#'*20+' {} '.format(epoch)+'#'*20)
...
def test():
    ...
    model = AgeClassify()
    model.load_model('/home/wei/Documents/CODE//BMVC/IPCGANs-Pytorch-master/checkpoint/pretrain_alexnet/saved_parameters/epoch_199.pth')
    # model.load_model('/home/wei/Documents/CODE/BMVC/IPCGANs-Pytorch-master/checkpoint/pretrained/age_cls_epoch_47_iter_0.pth')
    train_correct=0
    train_total=0
