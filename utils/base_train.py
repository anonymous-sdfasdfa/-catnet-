...
def pint_acc(acc_ls):
    print('the acc:')
    print('{:.3f} {:.3f} {:.3f} {:.3f}'.format(acc_ls[0],acc_ls[1],acc_ls[2],acc_ls[3]))
    print('the mean acc')
    print('{:.3f}'.format(np.mean(acc_ls)))

def pint_acc_ub(acc_ls):
    print('the acc:')
    print('{:.3f}'.format(acc_ls[0]))
    print('the mean acc')
    print('{:.3f}'.format(np.mean(acc_ls)))
