...
tf_device='/gpu:0'
for kin_ty in ['father-dau', 'father-son', 'mother-dau', 'mother-son']:
    #define read path
    root_data_dir="/home/wei/Documents/CODE/ECCV2022/CATNet3/data/KinFaceW-II/images/"
    image_root_dir=os.path.join(root_data_dir,"{}".format(kin_ty))
    #define store path
    store_root_dir="/home/wei/Documents/CODE/ECCV2022/CATNet3/data/KinFaceW-II-new/images/"
    store_image_dir=os.path.join(store_root_dir,"{}".format(kin_ty))
    ...
    images_list =[item for item in os.listdir(image_root_dir) if 'jpg' in item]
