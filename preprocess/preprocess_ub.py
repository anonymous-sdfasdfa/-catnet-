...
NUM = '03'
#define read path
root_data_dir="/home/wei/Documents/DATA/kinship/UB_Kinface/KinFace_V2"
image_root_dir=os.path.join(root_data_dir,NUM)
#define store path
store_root_dir="/home/wei/Documents/DATA/kinship/UB_Kinface/UB"
store_image_dir=os.path.join(store_root_dir,NUM)
...
for filename in tqdm(os.listdir(image_root_dir)):
    ...
    svname = 'co_{:03d}_1.jpg'.format(int(filename.split('.')[0]))
    storepath=os.path.join(store_image_dir,svname)
    # print(filepath)
    npimage=Image.open(filepath)
    npimage=npimage.convert(mode='RGB')
